  ...
  <header class="bg-base-100 p-5">
    <nav class="flex justify-between items-center">
      <div class="flex items-center">
        ...
        <div v-if="!isDropdownOpen" @click="toggleDropdown" class="lg:hidden cursor-pointer">
          <!-- Icon Button for opening dropdown -->
          <svg
            width="100"
            viewBox="0 0 24 24"
            fill="none"
        ...
        <div
          v-if="isDropdownOpen"
          ref="dropdownMenu"
          class="top-0 z-[99] dropdown-content mt-3 p-2 shadow bg-base-100 rounded-box absolute"
        >
          <div
          ...
          >
            ...
            <RouterLink to="/" class="text-md font-semibold whitespace-nowrap"
              >Recipe Saver
            </RouterLink>
          </div>
      ...
      <div class="hidden lg:flex items-center space-x-4">
        ...
        <RouterLink to="/meal-planner" v-if="props.loggedUser" class="btn">Meal Planner</RouterLink>
      </div>
    </nav>
  </header>
</template>
